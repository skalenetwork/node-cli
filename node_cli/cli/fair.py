...
@fair_cli.group(help="SKALE fair node commands")
def fair():
    pass


@fair.group(help="Fair node commands")
def node():
    pass
...
@click.option('--yes', is_flag=True, callback=abort_if_false,
              expose_value=False,
              prompt='Are you sure you want to remove the node from fair manager contracts?')
@check_inited
@streamed_cmd
def exit_node():
    fair_node_exit()