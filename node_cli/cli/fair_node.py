...
from node_cli.fair.fair_node import migrate_from_boot, request_repair, restore_fair
...
@node.command('signature', help='Get fair node signature for a validator ID.')
