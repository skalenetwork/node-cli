...
from node_cli.core.mirage_boot import init as init_boot
from node_cli.core.mirage_boot import update
...
from node_cli.mirage.mirage_boot import migrate, update
