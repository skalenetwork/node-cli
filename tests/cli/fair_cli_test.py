...
@mock.patch('node_cli.cli.fair_node.get_node_signature')
def test_fair_node_signature(mock_signature_core):
    runner = CliRunner()
    validator_id = '42'
...
@mock.patch('node_cli.cli.fair_node.get_node_signature')
def test_fair_node_signature_error(mock_signature_core):
    runner = CliRunner()
    validator_id = '43'
